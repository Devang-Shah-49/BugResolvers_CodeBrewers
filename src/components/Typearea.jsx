      ...
      <div className="mx-auto grid max-w-2xl items-center gap-x-8 gap-y-16 px-4 sm:px-6 lg:max-w-7xl  lg:px-10">
        <div className="grid  grid-rows" >
          <div className='flex flex-col justify-around'>
            <div className='text-4xl block p-2.5 w-full text-sm text-gray-900 bg-black rounded-lg border border-black focus:ring-blue-500 focus:border-blue-500' ref={givenText}>
